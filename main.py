...
class ParquetViewer(QMainWindow):
    ...
    def create_menu_bar(self):
        ...
        # Filter action
        self.filter_action = QAction("Show Column Filters", self)
        self.filter_action.setCheckable(True)
        self.filter_action.triggered.connect(self.toggle_filters)
        settings_menu.addAction(self.filter_action)
    ...
    def load_settings(self):
        ...
        if os.path.exists(self.config_file):
            ...
            self.show_filters = self.config.getboolean('Settings', 'show_filters', fallback=True)
        else:
        ...
        if hasattr(self, 'filter_action'):
            self.filter_action.setChecked(self.show_filters)
    ...
    def save_settings(self):
        ...
        self.config.set('Settings', 'show_filters', str(self.show_filters))
    ...
    def toggle_filters(self):
        ...
        self.show_filters = self.filter_action.isChecked()
        self.save_settings()
